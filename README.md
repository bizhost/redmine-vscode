...
npm 패키지 [`@bizhost/redmine-mcp`](https://www.npmjs.com/package/@bizhost/redmine-mcp)로 배포됨. Node 20+만 있으면 됨 (clone/build 불필요).
...
1. VS Code 확장 설치:
   ...
   (마켓플레이스에 "Redmine Issues"가 있으면 그걸로 설치해도 됨)
2. MCP 등록 전에 나에게 물어봐:
   - Redmine 서버 URL
